	...
	<div class = "all_wrap">
			...
			<div class="header-inner">
					...
					<div class="rankinglogo">
						<span><img src="rankingimages/ranking_logo.gif"></span></div>
			...
			<div class = "goods_contents_area">
				...
				<div class = "goods_contents">
					...
					<div class = "goods_img_area">
						...
						<img src = "Images/1.브리또/1000/1000.png" class = "goods_img">
				...
				<div class = "goods_info_area">
					...
					<div class = "goods_name">
						<input size="10"  name= "name" type = "text" value ="<%= name %>" style= "font-weight : bold; font-size : 1.5em; border-style: none; outline: none; width : 550px; padding-left : 0;" readonly/>
					</div>
					...
					<div class = "option_sel_area">
						...
						<div class = "option2_box">
							...
							<ul class = "select_goods">
									<li>
										<div id = "goods_name">
											...
											<span  style = "float : right; margin-top: 8px;">원</span>
										<div style = "display : inline;">
											<input  type = "text" id="price" name="price" style = "float:right;font-size:20px;font-weight:700;outline:none;background:#f5f5f5;border:1px solid #f5f5f5; text-align: right;" readonly value="22900">
										</div>
									</li>
								</ul>
							<div class = "total_price_area" >
								...
								<p class = "total_price">
										<strong id="total_price"  class="order_price">22900</strong>
									원
								</p>
			...
			<div class ="recommend_goods_area">
				...
				<%
					...
					ArrayList<ReviewDTO> r_list = dao.Review_all_2();
